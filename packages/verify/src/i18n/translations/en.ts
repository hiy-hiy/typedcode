...
export const en: VerifyTranslationKeys = {
  ...
  result: {
    ...
    poswSkippedQuick: 'Skipped (quick)',
  ...
  pattern: {
    ...
    charTiming: {
      normal: 'Natural timing variations between keys',
      tooUniform: 'Uniform typing time across all keys - Unnatural',
    },
    motor: {
      title: 'Motor Consistency Sample',
      highVariance: 'Largest Variance (Top 5)',
      lowVariance: 'Smallest Variance (Bottom 5)',
      keys: 'Keys',
      avgTime: 'Min - Max',
      dist: 'Dist',
      features: 'Features',
      ...
      altHand: 'Alt Hand',
      anyHand: 'Any Hand',
      sameFinger: 'Same Finger',
      diffFinger: 'Diff Finger',
